<?php
    ...
    if(!isset($_POST['user_id']) || !isset($_POST['pw']) || !isset($_POST['name'])) die("user_id, pw, name 중에 하나 이상이 보내지지 않았습니다");
    ...
    $result = mysqli_query($connect, $sql) or die("에러 발생1");
    ...
    $result = mysqli_query($connect, $sql) or die("에러 발생2");
